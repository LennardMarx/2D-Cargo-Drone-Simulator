...
void renderImages(SDL_Renderer *&_renderer, double _x_drone, double _y_drone, double _angle, double _x_cargo, double _y_cargo, bool _droneType, bool _choice1, bool _choice2)
{
    ...
    TexturedRectangle droneType(_renderer, "../images/droneType.bmp");
    droneType.Draw(0, 0, 1200, 800); // background for choice of drone
    TexturedRectangle integrationMethod(_renderer, "../images/integrationMethod.bmp");
    integrationMethod.Draw(0, 0, 1200, 800); // backdround for choice if integration method
    TexturedRectangle background(_renderer, "../images/background.bmp");
    background.Draw(0, 0, 1200, 800); // game background
    AnimatedSprite drone(_renderer, "../images/drone_animated.bmp");
    drone.Draw(x, y, droneW, droneH); // animated bmp of the drone (propellors turning)
    TexturedRectangle cargo(_renderer, "../images/cargo.bmp");
    ...
    if (_choice1 == 1 && _choice2 == 1) // show if both choices were taken
    {
        ...
        drone.PlayFrame(0, 0, 416, 107, frameNumber); // show correct "slot" of animation bmp
...
int main()
{
    ...
    while (!quit)
    {
        ...
        for (unsigned char c : keys_down)
        {
            ...
            else if (choice1 == 1 && choice2 == 1) // only start drone when choices were made
            {
                if (keyPress == 'u')
                {
        ...
        renderImages(ui.getRenderer(), x, y, angle, x_c, y_c, droneType, choice1, choice2);
