...
// get set drone type
bool UI::getDroneType()
{
    return droneType;
}
void UI::setDroneType(bool _droneType)
{
    droneType = _droneType;
}
// get set integration method
bool UI::getIntegrationMethod()
{
    return integrationMethod;
}
void UI::setIntegrationMethod(bool _integrationMethod)
{
    integrationMethod = _integrationMethod;
}
// get set choices (made at start of game - drone type, integration method)
bool UI::getChoice1()
{
    return choice1;
}
void UI::setChoice1(bool _choice1)
{
    choice1 = _choice1;
}
bool UI::getChoice2()
...
void UI::setChoice2(bool _choice2)
{
    choice2 = _choice2;
}
...
void UI::initialize(int sizeX, int sizeY)
{
    ...
    // Create a Window
    window = SDL_CreateWindow("Drone Simulation", 0, 0, sizeX, sizeY, SDL_WINDOW_SHOWN);
